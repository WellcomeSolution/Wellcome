...
class Mockup {
    fun getHosts() : ArrayList<Host>{
        ...
        val host2 = Host("MyTitle","MyDescription", getHostAddress(), "0668319800", ArrayList(),
            getHostSlotsDate(), getHostRestriction(), getHostConfiguration())
        val host3 = Host("MyTitle","MyDescription", getHostAddress(), "0668319800", ArrayList(),
            getHostSlotsDate(), getHostRestriction(), getHostConfiguration())
        val host4 = Host("MyTitle","MyDescription", getHostAddress(), "0668319800", ArrayList(),
            getHostSlotsDate(), getHostRestriction(), getHostConfiguration())
        return arrayListOf(host1, host2, host3, host4)
    }
