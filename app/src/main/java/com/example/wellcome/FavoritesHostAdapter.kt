...
class FavoritesHostAdapter(private val dataSet: ArrayList<HostPresenter>,
                        val viewModel : FavoritesHostViewModel) :
    RecyclerView.Adapter<FavoritesHostAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.favorites_host_single_line, viewGroup, false)
